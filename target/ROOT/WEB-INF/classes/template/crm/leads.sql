#namespace("crm.leads")
  #sql("queryById")
    ...
    from crm_leads as a left join admin_user as b on a.owner_user_id = b.user_id
    where leads_id = ?
  #end

  #sql("deleteByIds")
    delete from crm_leads where leads_id = ?
  #end
  ...
  #sql ("queryBatchIdByIds")
    select batch_id from crm_leads where leads_id in (#fori(ids))
  #end
#end
