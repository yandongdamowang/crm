...
public class ElasticsearchUtil {
    ...
    public IndexResponse add(EsIndexTypeId t) {
        ...
        try {
            indexResponse = ElasticSearchPlugin.getClient().index(request, RequestOptions.DEFAULT);
        } catch (Exception e) {
    ...
    public BulkResponse upsertAll(List<EsIndexTypeId> ts) {
        ...
        try {
            response = ElasticSearchPlugin.getClient().bulk(bulkRequest, RequestOptions.DEFAULT);
        } catch (Exception e) {
    ...
    public boolean existsIndex(String index) {
        ...
        try {
            exists = ElasticSearchPlugin.getClient().indices().exists(request, RequestOptions.DEFAULT);
        } catch (Exception e) {
    ...
    public DeleteResponse deleteById(EsIndexTypeId t) {
        ...
        try {
            deleteResponse = ElasticSearchPlugin.getClient().delete(request, RequestOptions.DEFAULT);
        } catch (Exception e) {
    ...
    public AcknowledgedResponse deleteIndex(String index) {
        ...
        try {
            acknowledgedResponse = ElasticSearchPlugin.getClient().indices().delete(request, RequestOptions.DEFAULT);
        } catch (Exception e) {
    ...
    public BulkResponse deleteByIds(String index, String type, List<Long> ids) {
        ...
        BulkResponse response = null;
        try {
            response = ElasticSearchPlugin.getClient().bulk(request, RequestOptions.DEFAULT);
        } catch (Exception e) {
...
//        request.waitForActiveShards(ActiveShardCount.ALL);
        ...
        try {
            updateResponse = ElasticSearchPlugin.getClient().update(request, RequestOptions.DEFAULT);
        } catch (Exception e) {
    ...
    public <T> T queryById(EsIndexTypeId t, Class<T> tClass) {
        ...
        try {
            documentFields = ElasticSearchPlugin.getClient().get(getRequest, RequestOptions.DEFAULT);
        } catch (Exception e) {
    ...
    public <T> PageEsData<T> searchPage(SearchSourceBuilder sourceBuilder, String index, String type, Class<T> tClass) {
        ...
        try {
            ...
            search = ElasticSearchPlugin.getClient().search(request, RequestOptions.DEFAULT);
        } catch (Exception e) {
