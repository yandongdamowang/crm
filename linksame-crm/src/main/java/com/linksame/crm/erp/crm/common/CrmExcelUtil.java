...
import com.linksame.crm.erp.crm.service.CrmProductService;
                ...
                if (rowIndex > 1) {
                    if (templateErr) {
                        ...
                        try {
                            ...
                            CrmCustomer customer = CrmCustomer.dao.findFirstByCache("CUSTOME_NAME", customeName, "select customer_id from crm_customer where customer_name = ? limit 1", customeName);
                            if (customer == null) {
                ...
                if (rowIndex > 1) {
                    if (templateErr) {
                        ...
                        try {
                            ...
                            CrmProductCategory category = CrmProductCategory.dao.findFirstByCache("CATEGORY_NAME", categoryName, "select category_id from crm_product_category where name = ? limit 1", categoryName);
                            if (category == null) {
