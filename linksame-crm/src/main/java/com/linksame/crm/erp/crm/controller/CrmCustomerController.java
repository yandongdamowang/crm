...
import com.linksame.crm.common.annotation.*;
...
import com.linksame.crm.erp.crm.entity.CrmCustomerSetting;
import com.linksame.crm.erp.crm.service.CrmBusinessService;
import com.linksame.crm.erp.crm.service.CrmContactsService;
import com.linksame.crm.erp.crm.service.CrmContractService;
import com.linksame.crm.erp.crm.service.CrmCustomerService;
    ...
    public void transfer(@Para("") CrmCustomer crmCustomer) {
        ...
        Db.tx(()->{
            for (String customerId : customerIdsArr) {
                if(Db.queryInt("select count(*) from `crm_customer` where find_in_set(?,ro_user_id) and customer_id = ?", BaseUtil.getUserId(),customerId)>0){
        ...
        try {
            ...
            for (int i = 0; i < recordList.size(); i++) {
                ...
                if ("map_address".equals(record.getStr("field_name"))) {
                    ...
                    List<String> provinceList = Db.query("select city_name from crm_area where parent_id = ?", 100000);
