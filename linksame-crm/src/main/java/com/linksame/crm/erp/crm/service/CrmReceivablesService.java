...
import com.linksame.crm.erp.crm.entity.CrmReceivablesPlan;
...
public class CrmReceivablesService {
    ...
    public R deleteByIds(String receivablesIds) {
        ...
        for (String id : idsArr) {
            ...
            Db.delete("delete FROM admin_fieldv where batch_id = ?", receivables.getBatchId());
    ...
    public List<Record> queryList(CrmReceivables receivables) {
        String sq = "select * from crm_receivables where 1 = 1 ";
