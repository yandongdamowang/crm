...
import com.linksame.crm.erp.admin.entity.AdminExamineStep;
        ...
        if (record != null) {
            if (record.getInt("examine_type") == 1) {
                ...
                if (id != null) {
                    ...
                    if (recordId != null) {
                        AdminExamineLog examineLog = AdminExamineLog.dao.findFirst("select * from admin_examine_log where record_id = ? and is_recheck = 0", recordId);
                        if(examineLog != null){
