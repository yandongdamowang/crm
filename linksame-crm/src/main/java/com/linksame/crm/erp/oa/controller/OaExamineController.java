...
import com.linksame.crm.erp.oa.entity.OaExamineLog;
import com.linksame.crm.erp.oa.entity.OaExamineRelation;
import com.linksame.crm.erp.oa.service.OaExamineService;
...
public class OaExamineController extends Controller {
    ...
    public void queryExamineRecordList(){
        Integer recordId = getInt("recordId");
        Integer examineId = Db.queryInt("select examine_id from `oa_examine_record` where record_id = ?",recordId);
