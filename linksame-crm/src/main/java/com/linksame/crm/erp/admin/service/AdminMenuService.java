...
public class AdminMenuService {
    ...
    public R getMenuListByType(Integer type) {
        Kv kv = new Kv();
        if (type == 1) {
            AdminMenu system = AdminMenu.dao.findFirst("select * from admin_menu where parent_id = 0 and realm = 'manage'");
            ...
            AdminMenu crm = AdminMenu.dao.findFirst("select * from admin_menu where parent_id = 0 and realm = 'crm'");
            ...
            kv.set("data", crm);
            AdminMenu bi = AdminMenu.dao.findFirst("select * from admin_menu where parent_id = 0 and realm = 'bi'");
            List<String> realmList = new ArrayList<>();
            realmList.add("oa");
            ...
            AdminMenu oa = AdminMenu.dao.findFirst("select * from admin_menu where parent_id = 0 and realm = 'oa'");
            ...
            AdminMenu project = AdminMenu.dao.findFirst("select * from admin_menu where parent_id = 0 and realm = 'project'");
