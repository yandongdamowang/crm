#namespace("oa.backLog")
  ...
  #sql ("queryTaskNum")
  select count(*) from task where status = 1 and (main_user_id = ? or owner_user_id like CONCAT('%,',?,',%'))
  #end
  ...
  #sql ("queryExamineNum")
  select count(*) from oa_examine_record as a left join oa_examine_log as b ON a.record_id = b.record_id
