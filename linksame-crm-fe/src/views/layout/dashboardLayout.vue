<template>
  <el-container>
    <el-header class="nav-container">
      <navbar :nav-index="9" @nav-items-click="navClick" />
    </el-header>
    <el-container>
      <el-aside width="auto" class="aside-container">
        <sidebar :items="dashboardRouters.children" main-router="dashboard">
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(['dashboard', 'dashboardRouters', 'headerName'])
    // 快捷添加
    // quickAddList() {
    //   var addItems = []
