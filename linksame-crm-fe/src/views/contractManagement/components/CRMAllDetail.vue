<template>
  <component v-if="id&&visible" :is="tabName" :crm-type="crmType" :id="id" :listener-ids="listenerIDs" :no-listener-ids="noListenerIDs" class="d-view" @handle="detailHandle" @hide-view="hiddenView" />
</template>
