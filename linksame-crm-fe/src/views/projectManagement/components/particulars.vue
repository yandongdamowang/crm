              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                  <el-upload
                    :http-request="httpRequest"
                    class="upload-demo"
                    action="http://192.168.1.174:28080/minio/uploadFilec"
                    multiple
                    list-type="picture"
                  >
                    <span>本地上传</span>
                  ...
                  <div v-if="!item.showEdit" class="show-edit">
                    ...
                    <div class="rt">
                      <flexbox class="rt-box">
                        <div
                          v-if="item.stopTime"
                          class="bg-color task-bg-color"
                        >{{ item.stopTime | moment("MM-DD") }} 截止</div>
                        <div
                          ...
                          <p class="reply-title">
                            <template>
                              ...
                              <span
                                ...
                                class="reply"
                              >@{{ childDiscussItem.replyUser.realname }}：</span>
                            </template>
